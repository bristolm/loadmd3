...
XCALL_(static int)
LOAD_RTCW_MDS (long version, GlobalFunc *global, 
							LWObjectImport *local, void *serverData)
{
	...
	if (strcmp(pExt,".mds") == 0 || strcmp(pExt,".MDS") == 0)
	{	// Load skeelton file
		retval = Load_MDS(local);
		// Be done
...
/*
XCALL_(static int)
GENERIC_RTCW_MDS (long version,GlobalFunc *global,
...
ServerRecord ServerDesc[] = {
    { LWOBJECTIMPORT_CLASS,		PLUGINNAME"OK",		LOAD_RTCW_MDS},
//    { LWLAYOUTGENERIC_CLASS,	PLUGINNAME,			GENERIC_RTCW_MDS},
    { NULL }
};